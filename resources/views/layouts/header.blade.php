            ...
            <div id="loading-center-absolute">
                ...
                <div class="tp-preloader-content">
                    <div class="tp-preloader-logo">
                        ...
                        <img src="assets/img/logo/preloader/xpress-logo2.png" alt=""
            ...
            <div class="tp-header-main tp-header-sticky">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-10 col-lg-3 col-md-8 col-6">
                        ...
                        <div class="row align-items-center">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="dropdown btn ">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="{{ route('products.index')}}">Laptops</a></li>
                                                        <li><a class="dropdown-item" href="#">Tablets/Ipads</a></li>
                            ...
                            <div class="col-xl-6 col-lg-3">
                                <div class="tp-header-contact d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="">
                                        <h5>Hotline:</h5>
                                        <p><a href="tel:402-763-282-46">+123 8123 553 756</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
